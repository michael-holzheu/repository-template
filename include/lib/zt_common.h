...
#define RELEASE_STRING	STRINGIFY (PACKAGE_RELEASE)
#define TOOLS_LIBDIR	STRINGIFY (PACKAGE_LIBDIR)
#define TOOLS_SYSCONFDIR STRINGIFY (PACKAGE_SYSCONFDIR)
#define TOOLS_BINDIR	STRINGIFY (PACKAGE_BINDIR)
