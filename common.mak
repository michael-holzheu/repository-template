...
PACKAGE_RELEASE = $(VERSION).$(RELEASE).$(PATCHLEVEL)-$(DISTRELEASE)
export PACKAGE_RELEASE
...
ALL_CFLAGS	= -DPACKAGE_RELEASE=$(PACKAGE_RELEASE) \
			-DPACKAGE_LIBDIR=$(TOOLS_LIBDIR) \
			-DPACKAGE_DATADIR=$(TOOLS_DATADIR) \
			-DPACKAGE_SYSCONFDIR=$(SYSCONFDIR) \
			-DPACKAGE_BINDIR=$(BINDIR) \
			$(CFLAGS)
CXXFLAGS	?= $(DEFAULT_CFLAGS) $(OPT_FLAGS)
ALL_CXXFLAGS	= -DPACKAGE_RELEASE=$(PACKAGE_RELEASE) \
			-DPACKAGE_LIBDIR=$(TOOLS_LIBDIR) \
			-DPACKAGE_DATADIR=$(TOOLS_DATADIR) \
			-DPACKAGE_SYSCONFDIR=$(SYSCONFDIR) \
			-DPACKAGE_BINDIR=$(BINDIR) \
...
$(rootdir)/libexample/libexample.a: $(rootdir)/libexample
	$(MAKE) -C $(rootdir)/libexample/ libexample.a
.PHONY: $(rootdir)/libexample
